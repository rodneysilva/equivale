...
public class ProductsController : ControllerBase
{
    ...
    public async Task<ActionResult<PagedResult<ProductDto>>> GetAll(
        ...
        [FromQuery] string? category = null, [FromQuery] string? search = null, [FromQuery] List<string>? tags = null, [FromQuery] string? sellerId = null, [FromQuery] string? communityId = null,
        CancellationToken cancellationToken = default)
    {
        var query = new Application.Queries.Products.GetAllProductsQuery(
            new PaginationParams { Page = page, PageSize = pageSize }, search, category, tags, sellerId, communityId);
