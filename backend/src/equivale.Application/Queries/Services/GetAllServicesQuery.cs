...
public record GetAllServicesQuery(PaginationParams Pagination, string? SearchTerm = null, string? Category = null, string? Tag = null) : IRequest<PagedResult<ServiceDto>>;
