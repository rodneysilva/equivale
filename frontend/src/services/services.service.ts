...
export const servicesService = {
  async getAll(page = 1, pageSize = 24, category?: string, search?: string, tags?: string[], providerId?: string, communityId?: string, sortBy?: string): Promise<PaginatedResponse<Service>> {
